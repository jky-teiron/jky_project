...
- (void)layoutSubviews
{
	...
	else
	{
		...
		CGRect frame = CGRectMake(0, 0, self.contentView.bounds.size.width, neededContentHeight);//这句就是影响attributedTextContextView frame的关键
...
- (CGFloat)requiredRowHeightInTableView:(UITableView *)tableView
{
	...
	CGSize neededSize = [self.attributedTextContextView suggestedFrameSizeToFitEntireStringConstraintedToWidth:contentWidth];
	 NSLog(@"1->%@", [NSValue valueWithCGRect:_attributedTextContextView.frame]);
